...
from . import layers
from .qanet_tail import QANet_tail
...
class RnnDocReader(nn.Module):
    ...
    def __init__(self, opt, padding_idx=0, embedding=None):
        ...
        if not opt['qanet_tail']:
            ...
            # Initializing QANet tail
            self.qanet_tail = QANet_tail(opt)
    ...
    def forward(self, x1, x1_f, x1_pos, x1_ner, x1_mask, x2, x2_mask):
        ...
        if not self.opt['qanet_tail']:
            # Merge hiddens and find start/end scores
            ...
            # Use QANet for additional encoding and 
            start_scores, end_scores = self.qanet_tail(doc_hiddens, x1_mask, question_hiddens, x2_mask)
